...
class JTNNEncoder(nn.Module):
    ...
    def __init__(self, hidden_size, depth, embedding, device):
        ...
        self.GRU = GraphGRU(hidden_size, hidden_size, depth, device)
...
class GraphGRU(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, depth, device):
